...
def parse_args():
    ...
    parser.add_argument('--model_path', default='./logs/fp/iter_100', help='path to model')
    ...
    parser.add_argument('--exp_name', type=str, default='kl_cyclical=False-rnn_size=256-predictor-posterior-rnn_layers=2-1-n_past=2-n_future=10-lr=0.0020-g_dim=128-z_dim=64-last_frame_skip=False-beta=0.0001000')
    parser.add_argument('--model_weights', type=str, default='99_model.pth')
